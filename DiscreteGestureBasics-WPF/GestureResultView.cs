...
namespace Microsoft.Samples.Kinect.DiscreteGestureBasics
{
    ...
    public sealed class GestureResultView : INotifyPropertyChanged
    {
        ...
        public void UpdateGestureResult(bool isBodyTrackingIdValid, bool isGestureDetected, float detectionConfidence , string ges)
        {
            int fly = 50;
            ...
            if (!this.IsTracked)
            {
                ...
                this.BodyColor = Brushes.Gray;
                 ...
                 Clipboard.SetText("notTrackedImage");
               // Random rnd = new Random();
               // string lk = @"C:\LogDir\MyNewTextFile.txt" + rnd.Next(1000);
               // System.IO.File.WriteAllText(lk, "notTrackedImage");
                int milliseconds = fly;
            ...
            else
            {
                ...
                if (this.Detected)
                {
                    ...
                    this.ImageSource = this.seatedImage;
                     ...
                     Clipboard.SetText(ges);
                  //  Random rnd = new Random();
                  //  string lk = @"C:\LogDir\MyNewTextFile.txt" + rnd.Next(1000);
                  //  System.IO.File.WriteAllText(lk, ges);
                    int milliseconds = fly;
                    Thread.Sleep(milliseconds);
                }
                else
                {
                  //  this.ImageSource = this.notSeatedImage;
                   ...
                   // Clipboard.SetText("NoDetectMove");
                   // Random rnd = new Random();
                   // string lk = @"C:\LogDir\MyNewTextFile.txt" + rnd.Next(1000);
                   // System.IO.File.WriteAllText(lk, "NoDetectMove");
                  /// int milliseconds = fly;
                   // Thread.Sleep(milliseconds);
                }
            }
